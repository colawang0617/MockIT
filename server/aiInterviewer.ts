...
export function generateInterviewerResponse(
    ...
    return (async function*() {
        ...
        if (shouldAskFinalQuestion) {
            ...
            additionalContext = `\n\nYou have asked ${session.questionsAsked} questions so far. You can ask ${questionsRemaining} more main questions (follow-ups counts). Time remaining: ${Math.floor(timeRemaining)} minutes.`;
        }
